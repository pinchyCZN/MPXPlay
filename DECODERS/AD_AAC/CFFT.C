...
**
** $Id: cfft.c,v 1.12 2003/09/21 00:00:00 PDSoft Exp $
**/
...
static void passf2(uint16_t ido, uint16_t l1, complex_t * cc, complex_t * ch, complex_t * wa, int8_t isign)
{
	uint32_t i, k, ah, ac;
...
static void passf3(uint16_t ido, uint16_t l1, complex_t * cc, complex_t * ch, complex_t * wa1, complex_t * wa2, int8_t isign)
{
...
static void passf4(uint16_t ido, uint16_t l1, complex_t * cc, complex_t * ch, complex_t * wa1, complex_t * wa2, complex_t * wa3, int8_t isign)
{
	uint32_t i, k, ac, ah;
...
static void passf5(uint16_t ido, uint16_t l1, complex_t * cc, complex_t * ch, complex_t * wa1, complex_t * wa2, complex_t * wa3, complex_t * wa4, int8_t isign)
{
...
static void cfftf1(uint16_t n, complex_t * c, complex_t * ch, uint16_t * ifac, complex_t * wa, int8_t isign)
{
	uint32_t i;
	uint32_t k1, l1, l2;
	uint32_t na, nf, ip, iw, ix2, ix3, ix4, ido, idl1;
...
static void cffti1(uint32_t n, complex_t * wa, uint16_t * ifac)
{
	static uint16_t ntryh[4] = { 3, 4, 2, 5 };
	real_t arg, argh, argld, fi;
	uint32_t ido, ipm;
	uint32_t i1, k1, l1, l2;
	uint32_t ld, ii, ip;
	uint32_t ntry, i, j;
	uint32_t ib;
	uint32_t nf, nl, nq, nr;

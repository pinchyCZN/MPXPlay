		...
		do {
			...
			if(metadata_size) {
				...
				case FLAC_METADATA_TYPE_STREAMINFO:
					...
					return 0;
				default:
					mpxplay_bitstream_skipbits(bs, metadata_size * 8);
				}
			}
		} while(!metadata_last);
	}
...
static char *flac_tag_get(struct mpxplay_filehand_buffered_func_s *fbfs, void *fbds, struct mpxplay_infile_info_s *miis, char **id3ip, char *id3p,

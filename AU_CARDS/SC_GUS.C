...
static void initgus(struct mpxplay_audioout_info_s *aui, int voices)
{
	int i;
	unsigned char l1 =
		"\x00\x00\x01\x03\x00\x02\x00\x04\x00\x00\x00\x05\x06\x00\x00\x07"[aui->
																		   card_irq] | ((aui->card_irq ==
																						 gusIRQ2) ? 0x40 : "\x00\x00\x08\x18\x00\x10\x00\x20\x00\x00\x00\x28\x30\x00\x00\x38"[gusIRQ2]);

...
static int snd_hda_codec_write(struct intelhd_card_s *chip, hda_nid_t nid,
                         uint32_t direct,
...
static int select_input_connection(struct intelhd_card_s *card, struct hda_gnode *node,
				   unsigned int index)
{

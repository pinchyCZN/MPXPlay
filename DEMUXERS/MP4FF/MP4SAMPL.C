...
**
** $Id: mp4sample.c,v 1.20 2005/01/12 00:00:00 PDSoft Exp $
**/

#include <stdlib.h>
#include "mp4ff.h"

static int32_t mp4ff_chunk_of_sample(const mp4ff_t * f, const int32_t track, const int32_t sample, int32_t * chunk_sample, int32_t * chunk)
{
...
static int32_t mp4ff_sample_range_size(const mp4ff_t * f, const int32_t track, const int32_t chunk_sample, const int32_t sample)
{
	int32_t i, total;
	const mp4ff_track_t *p_track = f->track[track];
...
int32_t mp4ff_set_sample_position(mp4ff_t * f, const int32_t track, const int32_t sample)
{
	...
	return mp4ff_set_position(f, offset);
}

...
unsigned int cv_channels_downmix(PCM_CV_TYPE_S *pcm_sample,unsigned int samplenum,unsigned int channelnum_in,mpxp_uint8_t *chanmatrix_in,unsigned int channelnum_out,mpxp_uint8_t *chanmatrix_out,struct mpxplay_audioout_info_s *aui)
{
  ...
  for(i=0;i<samplenum;i+=channelnum_in){
   ...
   for(c=0;c<channelnum_in;c++){
    ...
    switch(chanmatrix_in[c]){
     ...
     case MPXPLAY_PCMOUTCHAN_FRONT_CENTER:data*=0.5;outchans_f[MPXPLAY_PCMOUTCHAN_FRONT_LEFT]+=data;
                                           outchans_f[MPXPLAY_PCMOUTCHAN_FRONT_RIGHT]+=data;break;
#ifdef CVCHAN_USE_SURROUND
     case MPXPLAY_PCMOUTCHAN_REAR_LEFT:sdata+=data;surround=1;break;
     case MPXPLAY_PCMOUTCHAN_REAR_RIGHT:sdata+=data;surround=1;break;
     case MPXPLAY_PCMOUTCHAN_REAR_CENTER:data*=0.5;sdata+=data;surround=1;break;
#else
     ...
     case MPXPLAY_PCMOUTCHAN_REAR_CENTER:data*=0.5;outchans_f[MPXPLAY_PCMOUTCHAN_FRONT_LEFT]+=data;
                                          outchans_f[MPXPLAY_PCMOUTCHAN_FRONT_RIGHT]+=data;break;
#endif
     ...
     case MPXPLAY_PCMOUTCHAN_LFE:data*=0.5;outchans_f[MPXPLAY_PCMOUTCHAN_FRONT_LEFT]+=data;
                                     outchans_f[MPXPLAY_PCMOUTCHAN_FRONT_RIGHT]+=data;break;
    }
   }
#ifdef CVCHAN_USE_SURROUND

...
static unsigned long mpxplay_mpxinbuf_fread(void *fbds,void *ptr,unsigned long num)
{
 ...
 if(num>4)
  mpxplay_debugf(MPXPLAY_DEBUG_OUTPUT,"freadbeg pp:%5d gp:%5d r:%5d f:%5d n:%d fp:%d",frp->prebufferputp,frp->prebuffergetp,frp->prebufferbytes_rewind,frp->prebufferbytes_forward,num,mpxplay_mpxinbuf_ftell(frp));
#endif
...
#ifdef MPXINBUF_DEBUG_SEEK
 mpxplay_debugf(MPXPLAY_DEBUG_OUTPUT,"fseekbeg na:%5d nr:%5d pp:%5d gp:%5d r:%5d f:%5d",newpos_absolute,newpos_relative,frp->prebufferputp,frp->prebuffergetp,frp->prebufferbytes_rewind,frp->prebufferbytes_forward);
#endif
...
err_out_fseek:
#ifdef MPXINBUF_DEBUG_SEEK
 mpxplay_debugf(MPXPLAY_DEBUG_OUTPUT,"fseekend na:%5d nr:%5d pp:%5d gp:%5d r:%5d f:%5d fp:%d",newpos_absolute,newpos_relative,frp->prebufferputp,frp->prebuffergetp,frp->prebufferbytes_rewind,frp->prebufferbytes_forward,mpxplay_mpxinbuf_ftell(frp));
#endif
 return newpos_absolute;
}
